...
const Banner = () => {
    return (
        <div className="bg-[#F8FAFC] pb-20 max-w-7xl mx-auto">
            ...
            <div className="max-w-6xl grid lg:grid-cols-4 md:grid-cols-1 mx-auto gap-10 justify-center items-center">
                ...
                <div className="text-center bg-white shadow-lg py-10 space-y-2">
                    ...
                    <p className="text-[#64748B] text-[16px] text-center font-semibold">Interactions This Month</p>
                </div>
            </div>
        </div>
    )
